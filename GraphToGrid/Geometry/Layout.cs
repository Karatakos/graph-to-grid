...
public class Layout {
    ...
    public static bool AreSignificantlyDifferent(Layout layout1, Layout layout2) {
        ...
        return Math.Abs(d1 - d2) > G2GConfig.SignificantDistanceThreshold;
    }
    ...
    */
    public Energy Update(Vertex updatedVertex, Room updatedRoom) {
        ...
        foreach (KeyValuePair<Vertex, Room> kvp in Rooms) {
            ...
            if (!_roomPairEnergyCache.ContainsKey(roomPairKey)) {
                ...
                Energy.Collision = Math.Abs(Energy.Collision) < G2GConfig.Tolerance * 10 ? 0f : Energy.Collision;
                Energy.Connectivity = Math.Abs(Energy.Connectivity) < G2GConfig.Tolerance * 10 ? 0f : Energy.Connectivity;
    ...
    private float ComputeConnectivity(Room r1, Room r2) {
        ...
        if (contact < ((G2GConfig.DoorWidth - G2GConfig.Tolerance) + (G2GConfig.DoorToCornerMinGap * 2))) {
